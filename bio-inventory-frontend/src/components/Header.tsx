...
import { Search, MoreVertical, FileText, Package, History, Users, LogOut, DollarSign } from 'lucide-react';
            ...
            <div className="h-16 flex items-center justify-between px-4 md:px-6">
                <div className="flex items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-1">
                        ...
                        {user?.is_staff && <a href="#" onClick={(e) => {e.preventDefault(); onNavigate('funding')}} className={`flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${activePage === 'funding' ? 'text-primary-700 bg-primary-50 shadow-inner-soft' : 'text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50'}`}><DollarSign className="w-4 h-4 mr-2"/>Funding</a>}
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden border-t border-secondary-200 bg-white">
                    <nav className="px-4 py-4 space-y-2">
                        ...
                        {user?.is_staff && <a href="#" onClick={(e) => {e.preventDefault(); onNavigate('funding'); setIsMobileMenuOpen(false);}} className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${activePage === 'funding' ? 'text-primary-700 bg-primary-50' : 'text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50'}`}><DollarSign className="w-4 h-4 mr-3"/>Funding</a>}
