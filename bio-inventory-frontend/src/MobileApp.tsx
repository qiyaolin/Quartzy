...
import MobileLayout from './components/mobile/mobile-layout.tsx';
import MobileDashboardPage from './pages/mobile/dashboard-page.tsx';
import MobileInventoryListPage from './pages/mobile/inventory-list-page.tsx';
import MobileRequestsPage from './pages/mobile/requests-page.tsx';
import MobileNotificationsPage from './pages/mobile/notifications-page.tsx';
import MobileLoginPage from './pages/mobile/login-page.tsx';
